...
public class UCTest {
    ...
    public void detailContent() throws Exception {
        ...
        String content = spider.detailContent(Arrays.asList("https://drive.uc.cn/s/73daac5828714?public=1"));
