...
public class Cloud extends Spider {
    ...
    public void init(String extend) throws Exception {
        ...
        uc.init(ext.has("cookie") ? ext.get("cookie").getAsString() : "");
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) throws Exception {
        ...
        if (flag.contains("quark")) {
            url = quark.playerContent(flag, id, vipFlags);
        } else if (flag.contains("uc")) {
            url = uc.playerContent(flag, id, vipFlags);
        } else {
            url = ali.playerContent(flag, id, vipFlags);
        }
        return url;
    }
